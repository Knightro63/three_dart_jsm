...
class WebGPURenderPipeline {
  ...
  _getColorBlend(material) {
    ...
    switch (blending) {
      case NormalBlending:
        colorBlend["srcFactor"] = (premultipliedAlpha == true)
            ? GPUBlendFactor.One
      ...
      case SubtractiveBlending:
        ...
        colorBlend["dstFactor"] = (premultipliedAlpha == true)
            ? GPUBlendFactor.Zero
            : GPUBlendFactor.OneMinusSrcColor;
        colorBlend["operation"] = GPUBlendOperation.Add;
        break;
      ...
      case CustomBlending:
        ...
        colorBlend["operation"] =
            this._getBlendOperation(material.blendEquation);
        break;
  ...
  _getPrimitiveState(object, material) {
    ...
    if (object is Line == true && (object is LineSegments) != true) {
      ...
      descriptor["stripIndexFormat"] = (count > 65535)
          ? GPUIndexFormat.Uint32
          : GPUIndexFormat
              .Uint16; // define data type for primitive restart value
  ...
  _getShaderAttributes(nodeBuilder, geometry) {
    ...
    for (var slot = 0; slot < nodeAttributes.length; slot++) {
      ...
      var geometryAttribute = geometry.getAttribute(name);
      var bytesPerElement = (geometryAttribute != undefined)
