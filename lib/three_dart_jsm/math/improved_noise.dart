...
class ImprovedNoise{
  ...
  num noise(num x,num y,num z) {
    final floorX = Math.floor( x ), floorY = Math.floor( y ), floorZ = Math.floor( z );
    ...
    final xMinus1 = x - 1, yMinus1 = y - 1, zMinus1 = z - 1;
    final u = _fade( x ), v = _fade( y ), w = _fade( z );
    final A = _p[ X ] + Y, AA = _p[ A ] + Z, AB = _p[ A + 1 ] + Z, B = _p[ X + 1 ] + Y, BA = _p[ B ] + Z, BB = _p[ B + 1 ] + Z;
