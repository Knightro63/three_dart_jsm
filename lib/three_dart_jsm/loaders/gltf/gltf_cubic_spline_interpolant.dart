...
class GLTFCubicSplineInterpolant extends Interpolant {
  GLTFCubicSplineInterpolant(List<num> parameterPositions, List<num> sampleValues, int sampleSize, List? resultBuffer)
  ...
  List? copySampleValue(int index) {
    ...
    final result = this.resultBuffer,
  ...
  List? interpolate(int i1, num t0, num t, num t1) {
    final result = this.resultBuffer;
    final values = this.sampleValues;
    final stride = this.valueSize;
